...
'scribe.strategies.responseFields','scribe.database_connections_to_transact','scribe.fractal.serializer','services.postmark.token','services.resend.key',
...
'scribe','scribe.postman','scribe.openapi','sanctum.csrf-cookie',
'transactions.index','transactions.store','transactions.show','transactions.update','transactions.destroy',
'groups.index','groups.store','groups.show','groups.update','groups.destroy','storage.local',);
        registerArgumentsSet('views', 
'scribe.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'errors.unauthenticated','errors.unauthorized','errors.resource_not_found','errors.internal_server_error','passwords.password',
'validation.custom.email.unique','validation.custom.password.confirmed','validation.attributes.address','validation.attributes.age','validation.attributes.body',
'validation.attributes.cell','validation.attributes.city','validation.attributes.country','validation.attributes.date','validation.attributes.day',
'validation.attributes.excerpt','validation.attributes.first_name','validation.attributes.gender','validation.attributes.marital_status','validation.attributes.profession',
'validation.attributes.nationality','validation.attributes.hour','validation.attributes.last_name','validation.attributes.message','validation.attributes.minute',
'validation.attributes.mobile','validation.attributes.month','validation.attributes.name','validation.attributes.zipcode','validation.attributes.company_name',
'validation.attributes.neighborhood','validation.attributes.number','validation.attributes.password','validation.attributes.phone','validation.attributes.second',
'validation.attributes.sex','validation.attributes.state','validation.attributes.street','validation.attributes.subject','validation.attributes.text',
'validation.attributes.time','validation.attributes.title','validation.attributes.username','validation.attributes.year','validation.attributes.description',
'validation.attributes.password_confirmation','validation.attributes.current_password','validation.attributes.complement','validation.attributes.modality','validation.attributes.category',
'validation.attributes.blood_type','validation.attributes.birth_date',);
