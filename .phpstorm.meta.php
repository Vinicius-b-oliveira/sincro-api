...
'sanctum.csrf-cookie','transactions.index','transactions.store','transactions.show','transactions.update',
'transactions.destroy','groups.index','groups.store','groups.show','groups.update',
'groups.destroy','storage.local',);
