                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-transactions">POST api/v1/transactions</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-transactions--id-">
                                <a href="#endpoints-GETapi-v1-transactions--id-">GET api/v1/transactions/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-transactions--id-">
                                <a href="#endpoints-PUTapi-v1-transactions--id-">PUT api/v1/transactions/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-transactions--id-">
                                <a href="#endpoints-DELETEapi-v1-transactions--id-">DELETE api/v1/transactions/{id}</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-groups">
                                <a href="#endpoints-GETapi-v1-groups">Exibe uma lista dos grupos aos quais o usuário pertence.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-groups">
                                <a href="#endpoints-POSTapi-v1-groups">Armazena um novo grupo.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-groups--id-">
                                <a href="#endpoints-GETapi-v1-groups--id-">Exibe um grupo específico.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-groups--id-">
                                <a href="#endpoints-PUTapi-v1-groups--id-">Atualiza um grupo específico.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-groups--id-">
                                <a href="#endpoints-DELETEapi-v1-groups--id-">Remove um grupo.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-groups--group_id--invitations">
                                <a href="#endpoints-POSTapi-v1-groups--group_id--invitations">Armazena um novo convite para um grupo.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 255 caracteres. Example: <code>b</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value deve ser um endereço de e-mail válido. O campo value não pode ser superior a 255 caracteres. Example: <code>zbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value deve ter pelo menos 8 caracteres. Example: <code>-0pBNvYgxw</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value deve ser um endereço de e-mail válido. Example: <code>gbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<div class="bash-example">
    ...
    \"amount\": 60,
    \"type\": \"income\",
    \"transaction_date\": \"2025-10-15T18:32:28\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="group_id"                data-endpoint="POSTapi-v1-transactions"
               value=""
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="POSTapi-v1-transactions"
               value="b"
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 255 caracteres. Example: <code>b</code></p>
...
<small>number</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>O campo value deve ser pelo menos 0.01. Example: <code>60</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="2025-10-15T18:32:28"
               data-component="body">
    <br>
<p>O campo value deve ser uma data válida. Example: <code>2025-10-15T18:32:28</code></p>
        </div>
        </form>

                    <h2 id="endpoints-GETapi-v1-transactions--id-">GET api/v1/transactions/{id}</h2>
...
<p>The ID of the transaction. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-transactions--id-">PUT api/v1/transactions/{id}</h2>
...
<div class="bash-example">
    ...
    \"amount\": 60,
    \"type\": \"expense\",
    \"transaction_date\": \"2025-10-15T18:32:29\"
}"
</code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="group_id"                data-endpoint="PUTapi-v1-transactions--id-"
               value=""
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the groups table.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="title"                data-endpoint="PUTapi-v1-transactions--id-"
               value="b"
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 255 caracteres. Example: <code>b</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="2025-10-15T18:32:29"
               data-component="body">
    <br>
<p>O campo value deve ser uma data válida. Example: <code>2025-10-15T18:32:29</code></p>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-v1-transactions--id-">DELETE api/v1/transactions/{id}</h2>
...
<p>The ID of the transaction. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-groups">Exibe uma lista dos grupos aos quais o usuário pertence.</h2>
...
<form id="form-GETapi-v1-groups" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-groups');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-groups"
                    onclick="cancelTryOut('GETapi-v1-groups');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-groups">Armazena um novo grupo.</h2>
...
<form id="form-POSTapi-v1-groups" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-v1-groups');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-groups"
                    onclick="cancelTryOut('POSTapi-v1-groups');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="POSTapi-v1-groups"
               value="b"
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 255 caracteres. Example: <code>b</code></p>
...
<p>Example: <code>Eius et animi quos velit et.</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-groups--id-">Exibe um grupo específico.</h2>
...
<form id="form-GETapi-v1-groups--id-" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('GETapi-v1-groups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-groups--id-"
                    onclick="cancelTryOut('GETapi-v1-groups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="GETapi-v1-groups--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the group. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-groups--id-">Atualiza um grupo específico.</h2>
...
<form id="form-PUTapi-v1-groups--id-" data-method="PUT"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('PUTapi-v1-groups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-PUTapi-v1-groups--id-"
                    onclick="cancelTryOut('PUTapi-v1-groups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="PUTapi-v1-groups--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the group. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name"                data-endpoint="PUTapi-v1-groups--id-"
               value="b"
               data-component="body">
    <br>
<p>O campo value não pode ser superior a 255 caracteres. Example: <code>b</code></p>
...
<p>Example: <code>Eius et animi quos velit et.</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-groups--id-">Remove um grupo.</h2>
...
<form id="form-DELETEapi-v1-groups--id-" data-method="DELETE"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('DELETEapi-v1-groups--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-DELETEapi-v1-groups--id-"
                    onclick="cancelTryOut('DELETEapi-v1-groups--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="DELETEapi-v1-groups--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the group. Example: <code>1</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-groups--group_id--invitations">Armazena um novo convite para um grupo.</h2>
...
<span id="example-requests-POSTapi-v1-groups--group_id--invitations">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-groups--group_id--invitations">
</span>
<span id="execution-results-POSTapi-v1-groups--group_id--invitations" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-groups--group_id--invitations"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-groups--group_id--invitations"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-groups--group_id--invitations" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-groups--group_id--invitations">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-groups--group_id--invitations" data-method="POST"
      data-path="api/v1/groups/{group_id}/invitations"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-groups--group_id--invitations', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-groups--group_id--invitations"
                    onclick="tryItOut('POSTapi-v1-groups--group_id--invitations');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-groups--group_id--invitations"
                    onclick="cancelTryOut('POSTapi-v1-groups--group_id--invitations');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-groups--group_id--invitations"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/groups/{group_id}/invitations</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-groups--group_id--invitations"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-groups--group_id--invitations"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="group_id"                data-endpoint="POSTapi-v1-groups--group_id--invitations"
               value="1"
               data-component="url">
    <br>
<p>The ID of the group. Example: <code>1</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="POSTapi-v1-groups--group_id--invitations"
               value="gbailey@example.net"
               data-component="body">
    <br>
<p>O campo value deve ser um endereço de e-mail válido. O campo value não pode ser superior a 255 caracteres. Example: <code>gbailey@example.net</code></p>
        </div>
        </form>
